...
double armdegreeVar = .1;
double armKalmanAngle = 0;
double armKalmanUncertaintyAngle = 4;
...
void ArmKalmanFilter(double armKalmanState, double armKalmanUncertainty, double armKalmanInput, double armKalmanMeasurement) {
  ...
  armKalmanUncertainty = armKalmanUncertainty + .000256;
...
double ArmMPU6050_Read(){
  ...
  armstateAngle = armOffset + atanf(armAY/sqrtf(armAX*armAX + armAZ*armAZ))*57.3;
