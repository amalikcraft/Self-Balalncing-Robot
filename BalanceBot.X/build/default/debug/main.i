...
void ArmKalmanFilter(double KalmanState, double KalmanUncertainty, double KalmanInput, double KalmanMeasurement);
...
double armPID_U = 0;
double armMax = 5000;
double armKP = 35.0, armKI = 0.01, armKD = 0;
...
double ArmBalancePID(double InputAngle){
    ...
    else if(armIterm<-armMax)armIterm = -armMax;
...
void ArmMotor(_Bool direction, unsigned int steps){
...
void BothWheels(_Bool direction, unsigned int steps){
